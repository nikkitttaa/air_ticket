...
class AppColors {
  ...
  static Color grey6 = HexColor.fromHex('#9F9F9F');
  static Color grey7 = HexColor.fromHex('#DBDBDB');
  static Color white = HexColor.fromHex('#FFFFFF');
  static Color blue = HexColor.fromHex('#2261BC');
  static Color darkBlue = HexColor.fromHex('#00427D');
  static Color green = HexColor.fromHex('#3A633B');
  static Color darkGreen = HexColor.fromHex('#1E341F');
  static Color red = HexColor.fromHex('#FF5E5E');
